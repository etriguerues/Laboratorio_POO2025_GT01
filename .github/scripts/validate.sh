...
echo "--------------------------------------------------------"
echo "Iniciando validacion de Laboratorio 2 (OOP)..."
echo "--------------------------------------------------------"
...
REQUIRED_RELATIONSHIPS=(
    "Estudiante.*extends.*MiembroUniversitario"
    "EvaluacionRegular.*implements.*IEstrategiaEvaluacion"
    "EvaluacionPostgrado.*implements.*IEstrategiaEvaluacion"
)
